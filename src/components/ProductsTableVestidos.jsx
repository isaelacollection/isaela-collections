const TablaProductosVestidos = ({ productos, onDetalles, onEditar, onEliminar }) => {
  return (
          ...
          {productos.map((p) => (
            <tr key={p._id} className="border-t hover:bg-gray-50">
              ...
              <td className="py-2 px-4">
                <img
                  src={p.imagenUrl || p.imageVestido || p.imageVestido}
                  alt={p.nombreVestido}
...
export default TablaProductosVestidos;
