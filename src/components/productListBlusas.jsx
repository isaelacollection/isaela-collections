  ...
  useEffect(() => {
    const fetchProductos = async () => {
      try {
        ...
        const res1 = await fetch("https://server-backend-vf5p.onrender.com/api/productBlusas");
      ...
      <div className="products">
        ...
        {productosBlusas.map((p) => (
          ...
          <div className="product-card" key={p._id || p.id} >
            ...
            <h3 className="product-name">{p.nombreBlusa}</h3>
            <p className="product-price">${p.precioBlusa}</p>
            ...
            <div className="product-actions flex justify-between items-center p-2 w-full">
              ...
              <a
                href={`https://wa.me/593979906565?text=Hola,%20me%20interesa%20el%20producto:%20${p.nombreBlusa}%20que%20vi%20en%20la%20tienda.`}
                target="_blank"
...
export default ProductListBlusas;